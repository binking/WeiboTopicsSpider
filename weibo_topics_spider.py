...
TOPIC_CURL_STR = "curl '{topic_uri}?from=faxian_huati' -H 'Accept-Encoding: gzip, deflate, sdch' -H 'Accept-Language: zh-CN,zh;q=0.8' -H 'Upgrade-Insecure-Requests: 1' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36' -H 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8' -H 'Referer: http://d.weibo.com/100803' -H 'Cookie: SINAGLOBAL=7912212257618.43.1478585959985; _T_WM=86d2f9fdad4fd8343aa9ddd0620ab738; TC-Page-G0=cdcf495cbaea129529aa606e7629fea7; TC-V5-G0=28bf4f11899208be3dc10225cf7ad3c6; TC-Ugrow-G0=0149286e34b004ccf8a0b99657f15013; _s_tentry=weibo.com; Apache=508038804601.5982.1480474268587; ULV=1480474268594:13:13:3:508038804601.5982.1480474268587:1480385082935; login_sid_t=80e48a13934430fcb97989a0ba7312cd; UOR=,,login.sina.com.cn; WBtopGlobal_register_version=e91f392a3df0305e; SCF=Ap11mp4UEZs9ZcoafG0iD1wVDGjdyuPuLY8BpwtpvSEE2-X2x9e6ygRNAwly1W8NRDaSDb8TAIaVjv-LRBKdq_E.; SUB=_2A251OuwrDeTxGeNH7FoY9ibJzj2IHXVWTlrjrDV8PUNbmtAKLWyjkW8JrdN5tJkiKyeH3Lju9MfKTTAZOw..; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFeW27owGRPpMd86BMDO-AY5JpX5K2hUgL.Fo-4S0n4SonfSK22dJLoIpD39PS0McLoqCH8SCHFeF-RxbH8SEHFeb-R1Btt; SUHB=0BL4CXvjCUA7d4; ALF=1481103095; SSOLoginState=1480498299; un=zhejxoxv185015@163.com; wvr=6' -H 'Connection: keep-alive' -H 'Cache-Control: max-age=0' --compressed"
...
def extract_topic_info(topic_uri):
    ...
    if stat_nums_parser:
        ...
        if div_tag and len(div_tag.find_all(attrs={'class': re.compile(r'W_f')})) == 3:  # span or strong
            ...
            info_dict['read_num_dec'] = chin_num2dec(div_tag.find_all(attrs={'class': re.compile(r'W_f')})[0].text.encode('utf8'))
